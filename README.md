...
# Perspectives and further optimizations
1. Use the dedicated framework "scrapy"
2. Use AsyncIO + Aiohttp to make multiple(hundreds even) requests at the same time.
